...
def build_system_prompt(
    *,
    ...
    return (
        ...
        "selected, the system will execute the full automated triage "
        "pipeline (calculating granular fit scores, tailoring the resume, "
        "compiling HTML/PDF outputs, and creating/pushing a Git branch). "
